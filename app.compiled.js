...
function DonutChart(_ref10) {
  ...
  var slices = data.map(function (d, i) {
    ...
    var path = pct < 0.001 ? "" : "M ".concat(x1, " ").concat(y1, " A ").concat(R, " ").concat(R, " 0 ").concat(large, " 1 ").concat(x2, " ").concat(y2, " L ").concat(ix2, " ").concat(iy2, " A ").concat(r, " ").concat(r, " 0 ").concat(large, " 0 ").concat(ix1, " ").concat(iy1, " Z");
